# Complete Codebase: Desktop Pet Companion (Dragon, Dog, Cats, Luffy, Fox, Rabbit, Penguin, Hamster, Owl, Panda)

> **Project Directory:** `C:\Pet`  
> **Technology Stack:** Python 3.13, PyQt5 (Hardware-accelerated vector `QPainter`), PyInstaller, Win32 API  
> **Total Files Included:** 34 files  

## Project Overview

A fully vector-rendered, frameless, transparent desktop companion built with PyQt5. It features 12 switchable characters (Baby Dragon, Puppy Dog, Ghibli Cats Duo, Monkey D. Luffy with Gear 2/3/5 and rubber body physics, and 6 procedural chibi pets: Fox, Rabbit, Penguin, Hamster, Owl, Panda), autonomous behaviors, Pomodoro focus tracking, interactive speech bubbles, web dashboard control, and intelligent desktop integration.
...
- [core/characters.py](#corecharacterspy) - *Character profile registry (Dragon, Dog, Cats, Luffy, Fox, Rabbit, Penguin, Hamster, Owl, Panda), dialogue lines, and supported actions.*
